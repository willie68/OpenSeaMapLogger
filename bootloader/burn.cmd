...
C:\D-Platte\sprachen\Arduino\hardware\tools\avr\bin\avrdude -CC:\D-Platte\sprachen\Arduino\hardware\tools\avr\etc\avrdude.conf -v -v -v -v -patmega328p -cusbasp -Pusb -Uflash:w:E:\dropbox\Elektronik\Arduino\projekte\MCSDepthLogger\Software\OpenSeaMapLogger\bootloader\avr_boot-master\avr_boot.hex:i -Ulock:w:0x0F:m 
